...
export default {
  about_directus: "Directus Hakkında",
  activity: "Aktivite",
  activity_log: "Aktivite Geçmişi",
  activity_outside_directus: "Öge Directus dışında oluşturuldu.",
  add_field_filter: "Bir alan filtresi ekleyin",
  add_new: "Yeni Ekle",
  ...
  all: "Tümü",
  almost_done_copy:
    "Her arayüz ihtiyaçlarınıza göre yeniden yapılandırılabilir. Aşağıdakiler bu arayüz için mevcut olan opsiyonlardır.",
  almost_done_options: "Neredeyse Tamam! Şimdi sadece arayüz opsiyonlarını yeniden gözden geçirin.",
  api_installed: "API başarıyla yüklendi.",
  api_url: "API URL",
  asc: "artan",
  auto_generate: "Otomatik-Üret",
  auto_generated: "Otomatik olarak üretildi...",
  batch: "Toplu",
  ...
  cant_disable_primary:
    "Varolan bir alanda birincil anahtar özelliğini kaldıramazsınız. Bunun yerine alanı silin.",
  cant_sort_by_this_field: "Bu alan ile sıralama yapamazsınız",
  change_project: "Projeyi Değiştir",
  choose_interface: "Verinin nasıl değiştirileceğini belirlemek için bir arayüz seçin.",
  choose_one: "Bir tane seçin",
  choose_project: "Proje Seçin",
  clear: "Temizle",
  clear_value: "Değeri Temizle",
  click_to_toggle_all_none: "Tüm kolonu açıp kapatmak için değiştirin",
  collection: "Koleksiyon",
  collection_contains_items: "{collection} {count} öge içeriyor",
  collection_count: "Koleksiyon Yok | 1 Koleksiyon | {count} Koleksiyon",
  collection_invalid_name: "Geçersiz koleksiyon adı",
  collection_names_cannot_be_changed: "Koleksiyon adını değiştiremezsiniz.",
  collection_removed: "{collection} Koleksiyonu Silindi",
  collection_updated: "{collection} Koleksiyonu Güncellendi",
  collections: "Koleksiyonlar",
  "collections-directus_activity": "Aktivite",
  ...
  currently_selected: "Seçilen: {thing}",
  database_connection: "Veritabanı Bağlantısı",
  database_connection_copy:
    "Şimdi, projenin kullanacağı veri tabanına nasıl bağlanacağımızı bilmemiz gerekiyor.",
  datatype: "Veritipi",
  datatypes: {
    mysql: {
      BIGINT:
      ...
      FLOAT: "4 baytlık ondalık sayı.",
      INT:
        "Tamsayı. İşaretli ise (negatif tamsayıları kabul ediyorsa) değer -2,147,483,648 ile 2,147,483,647 arasında, değilse maksimum 4,294,967,295 olarak tanımlıdır.",
      LONGTEXT: "En fazla 4,294,967,295 karakterden oluşabilen karakter dizesi.",
      MEDIUMINT:
        "Tamsayı. İşaretli ise (negatif tamsayıları kabul ediyorsa) değer -8,388,608 ile 8,388,607 arasında, değilse maksimum 16,777,215 olarak tanımlıdır.",
      MEDIUMTEXT: "En fazla 16,777,215 karakterden oluşabilen karakter dizesi.",
      SMALLINT:
      ...
      VARCHAR:
        "Değişken uzunlukta ikiliksiz karakter dizesi. Uzunluk 0 ile 64,535 arasında olabilir. (MySQL 5.0.3+).",
      YEAR: "Yıl. `1901` ile `2155` arasında ya da `0000` olabilir."
    }
  },
  date_and_time: "Tarih ve Zaman",
  db_column_name: "Kolon Adı...",
  db_datatype: "{db} Veritipi",
  db_name: "Veritabanı Adı",
  db_password: "Veritabanı Kullanıcı Şifresi",
  db_type: "Veritabanı Tipi",
  db_update_failed: "Veritabanı güncellenemedi!",
  db_updated: "Veritabanı başarıyla güncellendi!",
  ...
  delete_role_are_you_sure:
    '"{name}" rolünü silmek istediğinize emin misiniz? Bu işlem geri alınamaz.',
  desc: "azalan",
  description: "Açıklama",
  dialog_beginning: "Diyalog Penceresi Başlangıcı (*)",
  discard_changes: "Değişiklikleri İptal Et",
  display_name: "Görünen İsim",
  done: "Tamam",
  dont_manage: "Düzenleme",
  dont_manage_copy:
  ...
  editing_item: "Öge Düzenle",
  editing_items: "{count} Ögeyi Toplu Düzenle",
  editing_my_profile: "Profilimi Düzenle",
  editing_single: "{collection} Koleksiyonunu Düzenle",
  email: "E-posta",
  email_address: "E-posta Adresi",
  embed: "Yerleştir",
  embed_placeholder: "YouTube, Vimeo, veya başka bir bağlantı",
  empty_collection: "Boş Koleksiyon",
  empty_collection_body: "Bu koleksiyonda şimdilik herhangi bir öge yok.",
  enable_manual_sorting: "Elle sıralamaya izin ver",
  enter_collection_name: "Koleksiyon adını giriniz...",
  ...
  errors: {
    ...
    "100": "Yanlış kullanıcı adı ve/veya şifre",
    "101": "Uzun süredir işlem yapılmadığı için oturum kapatıldı.",
    "102": "Uzun süredir işlem yapılmadığı için oturum kapatıldı.",
    "103": "Kullanıcı aktif değil",
    "106": "Yanlış kullanıcı adı ve/veya şifre",
    "107": "Kullanıcı bulunamadı",
    "-1": "API'ye erişim sağlanamadı"
  },
  ...
  fetching_data: "Verilere erişiliyor",
  field: "Alan",
  field_already_exists: "{field} Zaten Var",
  field_created: "{field} Alanı Oluşturuldu",
  field_removed: "{field} Alanı Kaldırıldı",
  field_type: "Alan Tipi",
  field_updated: "{field} Alanı Güncellendi",
  field_width: "Alan Genişliği",
  field_width_half: "Yarım Genişlik (Sarar)",
  field_width_left: "Yarım Genişlik (Sadece Sol)",
  field_width_right: "Yarım Genişlik (Sadece Sağ)",
  field_width_full: "Tam Genişlik",
  field_width_fill: "Sayfayı Doldur",
  field_width_note:
    "Alanın form düzeni içindeki genişliği. Bu genişlik farklı biçimlerde konumlandırılırılabilir. Bu yüzden formun konumu da içindeki alanların konumlarına göre değişkenlik gösterebilir.",
  fields: "Alanlar",
  fields_are_saved_instantly: "Alanlarda yapılan değişiklikler anında kaydedilir",
  fieldtypes: {
    alias: "Bir veri kaydetmeyen ya da kendisine ait bir veritabanı kolonu bulunmayan alanlar.",
    ...
    integer: "Tamsayı",
    json: "API yanıtında standart JSON formatı",
    lang: "Çeviri alanlarına özgü, dil anahtarını tutan alan",
    m2o: "Çoktan bire (Many-to-One) İlişki",
    managed: "Yönetilen (dokümantasyona bkz.)",
  ...
  file_type_not_accepted:
    "{filename} sunucuya yüklenemez çünkü bu alan için geçerli bir veri tipinde değil.",
  file_upload: "Dosya Yükle",
  forgot_password: "Şifremi Unuttum",
  greater_than: "Büyüktür",
  greater_than_equal: "Büyük veya eşittir",
  help_and_docs: "Yardım & Dokümantasyon",
  hidden: "Gizli",
  hidden_browse: "Listelemede Gizli",
  ...
  initial_schema_copy:
    "Varolan veritabanı mimarisinden birini seçin ya da sıfırdan başlayın. Bunu her zaman genişletebilir ve ince ayar çekebilirsiniz.",
  install: "Yükle",
  install_copy: "Bu API'nin kurulumu henüz yapılmamış. Yükleyip konfigüre etmek ister misiniz?",
  intelligent_defaults:
    "Gelişmiş ayarlar verinin veritabanında nasıl saklanacağı konusunda ince ayar yapmanıza olanak tanır.",
  interface: "Arayüz",
  ...
  item_saved: "Öge Kaydedildi | {count} Öge Kaydedildi",
  junction_collection: "Kesişim Koleksiyonu",
  keep_editing: "Düzenlemeye Devam Et",
  latency: "Gecikme",
  learn_more: "Dahasını öğren",
  leave_comment: "Yorum bırakın...",
  length: "Uzunluk",
  length_disabled_placeholder: "Üzunluk veri tipi tarafından belirlenmektedir",
  less_than: "Küçüktür",
  less_than_equal: "Küçüktür veya eşittir",
  limited: "Limitli",
  loading: "Yükleniyor...",
  load_more: "Daha Fazla Yükle",
  loading_more: "Daha fazla öge yükleniyor...",
  login: "Oturum Aç",
  ...
  my_activity: "Aktivitelerim",
  my_profile: "Profilim",
  name: "İsim",
  name_bookmark: "Yer imine ne isim vermek istersiniz?",
  name_field: "Let’s name this {field} field and add a helpful note for users.",
  navigate_changes:
    "Bu sayfadan ayrılmak istediğinize emin misiniz? Bu sayfadan ayrılırsanız değişikleriniz geçerli olmayacaktır.",
  new: "Yeni",
  new_field: "Yeni Alan",
  new_file: "Yeni Dosya",
  next: "Sonraki",
  no_collections: "Oluşturulmuş Koleksiyon Yok",
  no_collections_body: "Gözüküyor ki henüz bir koleksiyon oluşturmamışsınız.",
  no_fields: "Oluşturulmuş Alan Yok",
  no_fields_body: "Gözüküyor ki bu koleksiyon için oluşturulmuş bir alan yok.",
  no_files: "Dosya Yok",
  no_files_body: "Gözükiyor ki herhangi bir dosya yüklememişsiniz.",
  no_interface_error: "{field} alanı için henüz bir arayüz oluşturulmamış.",
  ...
  note: "Not",
  note_hidden: "[Daha Fazla Öğren](https://docs.directus.io/guides/collections.html#hidden)",
  note_icon: "Bu ikon uygulamanın navigasyon kenar çubuğunda görünür",
  note_managed:
    "[Daha Fazla Öğren](https://docs.directus.io/guides/collections.html#managing-collections)",
  note_note: "Tanım...",
  note_single: "[Daha Fazla Öğren](https://docs.directus.io/guides/collections.html#single)",
  notifications: "Bildirimler",
  numeric: "Sayısal",
  o2m: "Bire çok (One-to-Many) (O2M)",
  ok: "Tamam",
  open_on_gh: "GitHub'da aç",
  operator: "Operatör",
  ...
  password: "Şifre",
  password_reset_sent: "{email} adresine şifre sıfırlamanız için bir e-posta gönderdik.",
  permission_states: {
    always: "Her Zaman",
    create: "Oluştur",
    full: "Tümü",
    mine: "Sadece Benim",
    none: "Hiçbiri",
    on_create: "Oluşturuluşda (On Create)",
    on_update: "Güncellemede (On Update)",
    read: "Salt-Okunur",
    role: "Sadece Rol",
    update: "Güncelle"
  },
  permissions: "İzinler",
  permissions_admin: "Yöneticiler öntanımlı olarak tüm veri üzerinde tüm izinlere sahiptir.",
  permissions_no_collections: "Bu proje herhangi bir koleksiyona sahip değil.",
  popular: "Popüler",
  port: "Kapı (Port)",
  powered_by_directus: "Powered by Directus",
  preview_and_revert: "Gözden Geçir ve Eski Haline Döndür",
  primary_key: "Birincil Anahtar (Primary Key)",
  project: "Proje",
  ...
  remove: "Kaldır",
  remove_related: "İlişkili Ögeyi Kaldır",
  report_issue: "Sorun Bildir",
  request_feature: "Ek Özellik Talep Et",
  required: "Gerekli",
  reset_password: "Şifremi Sıfırla",
  reset_preferences: "Listelenen tüm tercihleri sıfırla",
  reset_to_default: "Öntanımlı girdilere sıfırla",
  revert: "Eski Haline Döndür",
  revert_copy: "Bu ögeyi {date} tarihindeki haline döndürmek istediğinize emin misiniz",
  role_count: "Rol yok | 1 Rol | {count} Rol",
  role_settings: "Rol Ayarları",
  roles: "Kullanıcı Rolleri",
  save: "Kaydet",
  save_and_add: "Kaydet ve Yeni Ekle",
  save_and_stay: "Kaydet ve Sayfada Kal",
  save_as_bookmark: "Yer İmi olarak Kaydet",
  save_as_copy: "Kopya Olarak Kaydet",
  schema: "Şema",
  search: "Ara",
  search_interface: "Arayüz ara...",
  select_existing: "Varolanlar İçinden Seç",
  select_field: "Bir Alan Seçiniz",
  select_fields: "Alan Seçiniz",
  select_from_device: "Cihazdan Seç",
  select_interface: "Arayüz seçiniz...",
  select_interface_below: "Aşağıdan bir arayüz seçiniz",
  select_statuses: "Durum Seçiniz",
  select_statuses_copy: "Kullanıcının kullanabileceği durumları seçiniz",
  server_details: "Sunucu Detayları",
  server_error: "Sunucu Hatası",
  server_error_copy: "Sunucu ve/veya veritabanında birşeyler ters gidiyor.",
  server_trouble: "Sunucu Sorunu",
  server_trouble_copy: "Daha sonra tekrar deneyin ya da sunucu yöneticisi ile irtibata geçin.",
  settings: "Ayarlar",
  settings_collections_fields: "Koleksiyonlar & Alanlar",
  settings_extensions: "Eklentiler",
  settings_global: "Global Ayarlar",
  settings_permissions: "Roller & İzinler",
  settings_project: "Proje Ayarları",
  settings_saved: "Ayarlar Kaydedildi",
  settings_update_database: "Veritabanını Güncelle",
  settings_update_database_confirm:
    "Bu işlem veritabanı şemasını son Directus versiyonu ile çalışacak şekilde günceller. Bu operasyonu yapmadan önce veritabanınızın yedeğini alın!",
  settings_update_database_subtext: "Betik Çalıştır",
  show_directus_collections: "Directus Sistem Koleksiyonlarını Göster",
  sign_in: "Oturum Aç",
  ...
  upload_exceeds_max_size:
    "{filename} karşıya yüklenemedi. Sunucu bu büyüklükteki dosyaları karşıya yüklemek için konfigüre edilmedi.",
  user_directory: "Kullanıcı Listesi",
  user_edit_warning:
    "Bu öge aynı anda {first_name} {last_name} tarafından da düzenleniyor. Lütfen kendisi ile koordineli olarak çalışın ve veri kaybına uğramayın.",
  ...
  writable_fields: "Yazılabilir Alanlar",
  writable_fields_copy: "Kullanıcının düzenleyebileceği alanları seçiniz",
  yes: "Evet"
};