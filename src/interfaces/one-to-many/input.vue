    ...
    <portal v-if="editItem" to="modal">
      ...
      >
        <div class="edit-modal-body">
          <v-form
            new-item
            :fields="relation.collection_many.fields"
            :collection="relation.collection_many.collection"
            :values="editItem"
...
export default {
  ...
  computed: {
    ...
    sortField() {
      return _.find(this.relation.collection_many.fields, { type: "sort" });
    },
    ...
    emitValue(value) {
      ...
      const newValue = value
        .map(after => {
          ...
          if (after[this.relatedPrimaryKeyField].startsWith("$temp_")) {
